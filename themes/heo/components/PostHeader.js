...
export default function PostHeader({ post, siteInfo, isDarkMode }) {
  ...
  return (
    <div
      id='post-bg'
      className='md:mb-0 -mb-5 w-full md:h-[30rem] h-[20rem] relative md:flex-shrink-0 overflow-hidden bg-cover bg-center bg-no-repeat z-10'>
      <style jsx>{`
        .coverdiv:after {
          position: absolute;
          content: '';
      ...
      <div
        ...
        <div
          id='post-info'
          className='absolute md:top-48 z-10 flex flex-col space-y-4 lg:-mt-12 w-full max-w-[86rem] px-5'>
          {/* 分类+标签 */}
