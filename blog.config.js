...
const BLOG = {
  ...
  NOTION_PAGE_ID:
      ...
      '1dce46586c1e80578a4ceea3fe0fb354,en:1dce46586c1e80578a4ceea3fe0fb354',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'LinhGo', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Go Further - Think Deeper', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://linhgo.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'LinhGo, Blog', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
      ...
      "Hey there! I'm a coder, a worker, and a foodie. Welcome to my blog! 🎉",
